package com.kmutt.sit.apps.fit.ijoint.sensor;
...
public class FitOrientation implements SensorEventListener {
...
//  private final Sensor mOrientationSensor;
  ...
  public FitOrientation(SensorManager sensorManager, WindowManager windowManager) {
